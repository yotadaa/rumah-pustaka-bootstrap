                        ...
                        <div class="gap-2 p-2 border-bottom row justify-content-start">
                            ...
                            <div class="gap-3 overflow-auto d-flex col-12 col-sm align-items-center">
                                ...
                                <div class="gap-2 d-flex">
                                    ...
                                    <!-- Details Button -->
                                    <a @if ($type == 'iso') href="{{ route('admin.iso.divisi', ['id' => $item->id]) }}" @else href="{{ route('admin.akreditasi.komponen', ['id' => $item->id, 'role_id' => -1]) }}" @endif
                                    ...
                                    @if ($type == 'iso')
                                        <button type="button" style="padding: 10px 10px;"
                                            ...
                                            <i class="fas fa-download" wire:loading.remove
                                                wire:target="downloadZip"></i>
